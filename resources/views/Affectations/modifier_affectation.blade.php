...
@section('title')
    TASMIME WEB | {{__('MyCustom.Modifier_une_affectation')}}
@endsection
@section('content')
    <div class="container">
        <div class="row">
                ...
                <div class="card my-2 bg-light ">
                    <div class="card-header" style="background:linear-gradient(to right top, #c8c790, #b2c89a, #a0c8a7, #94c6b3, #8fc2bd);">
                        <div class="text-center">
                            <h3 class="text-white">{{__('MyCustom.Modifier_une_affectation')}}</h3>
                        </div>
                    </div>

                    <div class="card-body bg-light">
                        <form method="POST" action="{{ route('affectation.update',$data->id_affectation)}}">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
