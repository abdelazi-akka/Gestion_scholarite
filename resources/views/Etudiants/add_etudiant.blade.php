...
@section('title')
    TASMIME WEB | {{__('MyCustom.Ajouter_un_étudiant')}}
@endsection
@section('content')
    <div class="container">
        <div class="row">
                ...
                <div class="card my-2 bg-light ">
                    <div class="card-header" style="background:linear-gradient(to right top, #c8c790, #b2c89a, #a0c8a7, #94c6b3, #8fc2bd);">
                        <div class="text-center">
                            <h3 class="text-white">{{__('MyCustom.Ajouter_un_étudiant')}}</h3>
                        </div>
                    </div>
                    ...
                    <div class="card-body bg-light">
                        <form method="POST" action="{{ route('Etudiant.store')}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="code_groupe" type="text"  class="form-control" name="nom"placeholder="{{__('MyCustom.placeholder_LastName')}}" required>
                                    @error('nom')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="code_groupe" type="text"class="form-control" name="prenom"placeholder="{{__('MyCustom.placeholder_FirstName')}}" required>
                                    @error('prenom')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="code_groupe" type="text" class="form-control" name="cin"placeholder="{{__('MyCustom.placeholder_cin')}}" required>
                                    @error('cin')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="code_groupe" type="text"class="form-control" name="adresse"placeholder="{{__('MyCustom.placeholder_Adresse')}}" required>
                                    @error('adresse')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="code_groupe" type="text" class="form-control" name="telephonne"placeholder="{{__('MyCustom.placeholder_Téléphone')}}" required>
                                    @error('telephonne')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="cne" type="text" class="form-control" name="cne"placeholder="{{__('MyCustom.placeholder_CNE')}}" required>
                                    @error('cne')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="num_appoge" type="text"class="form-control" name="num_appoge"placeholder="{{__('MyCustom.placeholder_NumAppoge')}}" required>
                                    @error('num_appoge')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
