...
@section('title')
TASMIME WEB | {{__('MyCustom.Ajouter_un_module')}}
@endsection
@section('content')
    <div class="container">
        <div class="row">
                ...
                <div class="card my-2 bg-light ">
                    <div class="card-header" style="background:linear-gradient(to right top, #c8c790, #b2c89a, #a0c8a7, #94c6b3, #8fc2bd);">
                        <div class="text-center">
                            <h3 class="text-white">{{__('MyCustom.Ajouter_un_module')}}</h3>
                        </div>
                    </div>
                    <div class="card-body bg-light">
                        <form method="POST" action="{{ route('module.store')}}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="code_module" type="text"class="form-control"name="code_module"placeholder="{{__('MyCustom.placeholder_Code_Module')}}" required>
                                    @error('code_module')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="intitule_module"type="text"class="form-control"name="intitule_module"placeholder="{{__('MyCustom.placeholder_Intitulé_du_Module')}}"required>
