                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <x-text-input id="nom" class="form-control block w-100  w-full" type="text" name="nom" :value="old('nom')" required autofocus placeholder="{{Lang::get('MyCustom.First_name')}}" />
                                        <x-input-error :messages="$errors->get('nom')" class="text-danger" />
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <x-text-input id="prenom" class="form-control block  w-full" type="text" name="prenom" :value="old('prenom')" required autofocus placeholder="{{Lang::get('MyCustom.last_name')}}"/>
                                        <x-input-error :messages="$errors->get('prenom')" class="text-danger" />
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <x-text-input id="cin" class="form-control block  w-full" type="text" name="cin" :value="old('cin')" required autofocus placeholder="CIN" />
                                        <x-input-error :messages="$errors->get('cin')" class="text-danger" />
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <x-text-input  id="email" class="form-control block w-100  w-full" placeholder="Email" type="email" name="email" :value="old('email')" required/>
